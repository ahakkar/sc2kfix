...
void InstallSoundEngineHooks_SC2K1996(void) {
	...
	SafePatchJmp(
		(LPVOID)0x4026DF,
		Hook_Sound_PlayActionThingSound,
		"Hook_Sound_PlayActionThingSound"
	);
	...
	SafePatchJmp(
		(LPVOID)0x402B8A,
		Hook_Sound_LoadActionThingSound,
		"Hook_Sound_LoadActionThingSound"
	);
	...
	SafePatchJmp(
		(LPVOID)0x402F31,
		Hook_Sound_StopActionThingSound,
		"Hook_Sound_StopActionThingSound"
	);
